<?php
	...
	$posts = array(
				array(
					...
					"post-author"  => "Mark",
					"post-content" => "<p>This blog post shows a few different types of content that's supported and styled with Bootstrap. Basic typography, images, and code are all supported.</p>
	            <hr>
